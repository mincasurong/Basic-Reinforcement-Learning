...
%                 temp2 = printEpisode(Q,row,col,start,goal,wind,iteration,N_decision,step,Rewardsum);
%                 iteration
%                 figure('color','w');
...
function temp2 = printEpisode(Q,row,col,start,goal,wind,iteration,N_decision,step,Rewardsum)
...
title(sprintf('Windy grid-world, Converges on episode - %d \n Step: %d, Reward_{Sum}: %d', iteration,step,Rewardsum));
end
